...
public class BorderContentPanel extends JPanel
{
  ...
  public BorderContentPanel()
  {
    ...
    borderCorner1 = loader.loadImage("res/images/borderCorner.png",false);
    borderEdge1 = loader.loadImage("res/images/borderEdge1.png",false);
    borderCorner2 = loader.getRotatedImage(borderCorner1,90);
    borderEdge2 = loader.loadImage("res/images/borderEdge2.png",false);
